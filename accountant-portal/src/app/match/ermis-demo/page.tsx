...
const mockOverrides = {
  'req-0': { label: 'Έχετε λάβει επιχορήγηση από άλλο πρόγραμμα για τις ίδιες δαπάνες τα τελευταία 3 χρόνια;' },
  'req-1': { label: 'Μπορείτε να διατηρήσετε προσωπικό που αντιστοιχεί σε τουλάχιστον 2 εργαζομένους πλήρους απασχόλησης (ή ισοδύναμο, π.χ. 4 με μισή απασχόληση) για έναν χρόνο μετά το πρόγραμμα;' },
  ...
  'req-4': { label: 'Έχετε ενεργό τραπεζικό λογαριασμό στο όνομα της επιχείρησης;' },
}
