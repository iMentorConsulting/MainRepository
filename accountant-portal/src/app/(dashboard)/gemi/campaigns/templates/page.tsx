      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            // Program 1
            ['{{program_title}}', 'Πρόγραμμα 1'],
            ['{{program_description}}', 'Περιγραφή Προγράμματος 1'],
            ['{{program_url}}', 'Σελίδα Προγράμματος 1'],
            ['{{program_deadline}}', 'Προθεσμία Προγράμματος 1'],
            ['{{program_amount}}', 'Ποσό Επένδυσης 1'],
            ['{{program_subsidy}}', '% Επιχορήγησης 1'],
            ['{{program_extra_criteria}}', 'Πρόσθετες Προϋποθέσεις 1'],
            ['{{program_match_reason}}', 'Λόγοι Επιλεξιμότητας 1'],
            ['{{program_monthly_amount}}', 'Μηνιαία Επιχορήγηση 1 (ΔΥΠΑ)'],
            ['{{program_subsidy_months}}', 'Μήνες Επιχορήγησης 1 (ΔΥΠΑ)'],
            ['{{program_total_benefit}}', 'Συνολικό Όφελος 1 (ΔΥΠΑ)'],
            ['{{program_beneficiaries}}', 'Ωφελούμενοι 1 (ΔΥΠΑ)'],
            ['{{program_regions}}', 'Περιοχή Ισχύος 1'],
            ['{{ermis_link}}', 'Σύνδεσμος Ερμή 1'],
            // Program 2
            ['{{program2_title}}', 'Πρόγραμμα 2'],
            ['{{program2_description}}', 'Περιγραφή Προγράμματος 2'],
            ['{{program2_url}}', 'Σελίδα Προγράμματος 2'],
            ['{{program2_deadline}}', 'Προθεσμία Προγράμματος 2'],
            ['{{program2_amount}}', 'Ποσό Επένδυσης 2'],
            ['{{program2_subsidy}}', '% Επιχορήγησης 2'],
            ['{{program2_extra_criteria}}', 'Πρόσθετες Προϋποθέσεις 2'],
            ['{{program2_match_reason}}', 'Λόγοι Επιλεξιμότητας 2'],
            ['{{program2_monthly_amount}}', 'Μηνιαία Επιχορήγηση 2 (ΔΥΠΑ)'],
            ['{{program2_subsidy_months}}', 'Μήνες Επιχορήγησης 2 (ΔΥΠΑ)'],
            ['{{program2_total_benefit}}', 'Συνολικό Όφελος 2 (ΔΥΠΑ)'],
            ['{{program2_beneficiaries}}', 'Ωφελούμενοι 2 (ΔΥΠΑ)'],
            ['{{program2_regions}}', 'Περιοχή Ισχύος 2'],
            ['{{ermis_link_2}}', 'Σύνδεσμος Ερμή 2'],
            // Program 3
            ['{{program3_title}}', 'Πρόγραμμα 3'],
            ['{{program3_description}}', 'Περιγραφή Προγράμματος 3'],
            ['{{program3_url}}', 'Σελίδα Προγράμματος 3'],
            ['{{program3_deadline}}', 'Προθεσμία Προγράμματος 3'],
            ['{{program3_amount}}', 'Ποσό Επένδυσης 3'],
            ['{{program3_subsidy}}', '% Επιχορήγησης 3'],
            ['{{program3_extra_criteria}}', 'Πρόσθετες Προϋποθέσεις 3'],
            ['{{program3_match_reason}}', 'Λόγοι Επιλεξιμότητας 3'],
            ['{{program3_monthly_amount}}', 'Μηνιαία Επιχορήγηση 3 (ΔΥΠΑ)'],
            ['{{program3_subsidy_months}}', 'Μήνες Επιχορήγησης 3 (ΔΥΠΑ)'],
            ['{{program3_total_benefit}}', 'Συνολικό Όφελος 3 (ΔΥΠΑ)'],
            ['{{program3_beneficiaries}}', 'Ωφελούμενοι 3 (ΔΥΠΑ)'],
            ['{{program3_regions}}', 'Περιοχή Ισχύος 3'],
            ['{{ermis_link_3}}', 'Σύνδεσμος Ερμή 3'],
            // Back-compat aliases
            ['{{extra_criteria}}', '(= program_extra_criteria — compat)'],
            ['{{match_reason}}', '(= program_match_reason — compat)'],
          ].map(([key, lbl]) => (
