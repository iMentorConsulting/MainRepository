  ...
  <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding:36px 40px 28px;">
              ...
              <p style="margin:24px 0 8px;font-size:26px;font-weight:800;color:#ffffff;line-height:1.25;letter-spacing:-0.5px;">Ευκαιρία Χρηματοδότησης<br />για την Επιχείρησή σας</p>
              <p style="margin:0;font-size:15px;color:rgba(255,255,255,0.8);line-height:1.5;">Βρήκαμε ένα πρόγραμμα που ταιριάζει με τη δραστηριότητα της <strong style="color:#fff;">{{business_name}}</strong></p>
            </td>
          </tr>
    ...
    <tr>
      <td style="padding:32px 40px 0;text-align:center;">
        ...
        <p style="margin:14px 0 0;font-size:13px;color:#6b7280;">ή επισκεφθείτε το <a href="{{ermis_link}}" style="color:#2563eb;text-decoration:underline;">Μητρώο Ερμής</a></p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:28px 40px;">
        <p style="margin:0 0 8px;font-size:14px;color:#374151;line-height:1.7;">Είμαστε στη διάθεσή σας για οποιαδήποτε επιπλέον πληροφορία ή διευκρίνιση σχετικά με την επιλεξιμότητα της επιχείρησής σας και τη διαδικασία υποβολής αίτησης.</p>
...
export async function POST() {
  ...
  const template = await prisma.gemiEmailTemplate.create({
    data: {
      ...
      description: 'Προεπιλεγμένο πρότυπο ενημέρωσης επιχειρήσεων ΓΕΜΗ για επιλέξιμα προγράμματα',
