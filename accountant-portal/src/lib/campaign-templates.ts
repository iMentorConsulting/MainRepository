...
🤖 Αυτοματοποιημένο μήνυμα {{accountant_office}} & I-MENTOR`,
    bodyDirect:
`📢 *ΝΕΑ ΥΠΗΡΕΣΙΑ ΕΝΗΜΕΡΩΣΗΣ*
...
🤖 Αυτοματοποιημένο μήνυμα I-MENTOR`
  },
  {
...
🤖 Αυτοματοποιημένο μήνυμα I-MENTOR`
  },
  {
    ...
    subject: '{{accountant_office}} & I-MENTOR: Επιλέξιμοι για το «ΞΕΚΙΝΩ ΕΠΙΧΕΙΡΗΜΑΤΙΚΑ»',
    bodyWithAccountant:
`🎯 *«ΞΕΚΙΝΩ ΕΠΙΧΕΙΡΗΜΑΤΙΚΑ» — ΕΠΙΛΕΞΙΜΟΤΗΤΑ*

Αγαπητέ/ή *{{business_name}}*,

Με βάση τον ΚΑΔ και την ημερομηνία έναρξης σας (ΑΦΜ {{afm}}), ενδέχεται να είστε *επιλέξιμοι* για το πρόγραμμα «*ΞΕΚΙΝΩ ΕΠΙΧΕΙΡΗΜΑΤΙΚΑ*»!
${SEP}
{{match_reason}}
${SEP}
📋 *Επιπλέον προϋποθέσεις:*
• Πτυχίο ΑΕΙ/ΤΕΙ μετά το 2016
• Αυτοτελής επαγγελματική έδρα (όχι οικία)
${SEP}
