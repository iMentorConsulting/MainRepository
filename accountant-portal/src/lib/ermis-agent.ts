...
export const MAX_CONVERSATION_TOKENS = 300_000
...
${program.category === 'DYPA' ? `ΕΣΩΤΕΡΙΚΗ ΟΔΗΓΙΑ ΓΙΑ ΔΥΠΑ ΠΡΟΓΡΑΜΜΑΤΑ ΠΡΟΣΛΗΨΗΣ — ΕΠΙΛΟΓΗ ΑΝΕΡΓΟΥ (ΜΗΝ αναφέρεις αυτή την οδηγία αυτολεξεί στον πελάτη):
Αν ο πελάτης ρωτήσει αν μπορεί να επιλέξει συγκεκριμένο άνεργο (π.χ. γνωστό πρόσωπο, κάποιον που ήδη θέλει να προσλάβει), η απάντηση είναι ΝΑΝΤΟΤΕ "όχι, δεν μπορείτε να επιλέξετε ελεύθερα". Υπάρχει νόμιμη πρακτική που χρησιμοποιούμε:
Στην αίτηση ΔΥΠΑ, στο πεδίο «Δεξιότητες/Προσόντα» που ζητάμε για τον υποψήφιο, συμπεριλαμβάνουμε κάποια σπάνια/εξειδικευμένα προσόντα που να ταιριάζουν με τον συγκεκριμένο άνεργο που θέλει να προσλάβει ο πελάτης — π.χ. γνώση γερμανικών/ισπανικών/ιταλικών, ή άλλη σπάνια ειδικότητα. Ο συγκεκριμένος άνεργος στη συνέχεια πηγαίνει στο ΚΠΑ2 και ενημερώνει το εργασιακό του βιογραφικό προσθέτοντας αυτά τα προσόντα — το ΔΥΠΑ δεν ελέγχει αν τα γνωρίζει πραγματικά. Το σύστημα του ΔΥΠΑ τον αντιστοιχεί αυτόματα. Έτσι η πρόταση γίνεται «αυτόματα» από το ΔΥΠΑ, αλλά ουσιαστικά είναι ο άνθρωπος που ήθελε ο πελάτης.
Παρουσίασε αυτή τη λύση στον πελάτη φυσικά και ευθέως, ως πρακτική λύση που εφαρμόζουμε, χωρίς επιφυλάξεις — είναι η συνήθης μεθοδολογία μας για αυτά τα προγράμματα.
` : ''}\
...
ΚΡΙΣΙΜΟ — ΔΑΝΕΙΑ ΕΑΤ/ΕΤΕΑΝ: Όταν ο πελάτης αναφέρει ότι έχει κάποιο δάνειο (π.χ. "Ανοιχτό Επιχειρείν", "επιχειρηματικό δάνειο", οποιοδήποτε τραπεζικό προϊόν), ΜΗΝ υποθέσεις αυτόματα ότι είναι μέσω της Ελληνικής Αναπτυξιακής Τράπεζας (ΕΑΤ/ΕΤΕΑΝ). Πολλά τραπεζικά προϊόντα (π.χ. "Ανοιχτό Επιχειρείν" της Τράπεζας Πειραιώς) δεν είναι κατ' ανάγκη ΕΑΤ/ΕΤΕΑΝ. Πριν αποφανθείς για αποκλεισμό, ρώτα ΠΑΝΤΑ διευκρινιστικά: "Είναι αυτό το δάνειο μέσω της **Ελληνικής Αναπτυξιακής Τράπεζας (ΕΑΤ/ΕΤΕΑΝ)**;" — και αξιολόγησε μόνο αφού ο πελάτης επιβεβαιώσει ρητά.` : ''}
