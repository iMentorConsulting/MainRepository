...
<div style="background:white;padding:32px 40px;">
  ...
  <div style="background:#fef3c7;border:2px solid #f59e0b;border-radius:12px;padding:20px 22px;margin:16px 0;">
    ...
    <ul style="margin:0;padding-left:20px;font-size:14px;color:#78350f;line-height:2;">
      <li>Η πλατφόρμα <strong>ειδοποιεί αυτόματα</strong> τον πελάτη όταν βρεθεί πρόγραμμα που τον αφορά</li>
      <li>Η ειδοποίηση στέλνεται <strong>στο όνομα του γραφείου σας</strong>, με το λογότυπό σας</li>
      <li>Ο πελάτης σας βλέπει ως τον σύμβουλό του που τον φροντίζει — <strong>χωρίς εσείς να κάνετε τίποτα</strong></li>
    </ul>
...
<div style="background:white;padding:32px 40px;">
  ...
  ${emailSection('🤝', 'Το κύριο: ο πελάτης να φεύγει ικανοποιημένος', `
    ...
    <br/><br/>
    Δεν χρειάζεται να κάνετε τίποτα επιπλέον: η πλατφόρμα εντοπίζει τα ταιριάσματα, η I-MENTOR αναλαμβάνει την υλοποίηση. <strong>Εσείς είστε ο σύμβουλος που έκανε τη σύνδεση.</strong>
  `)}
...
<div style="background:white;padding:32px 40px;">
  ...
  ${emailSection('🔍', 'Αυτόματο matching επιχειρήσεων με προγράμματα', `
    Κάθε πελάτης σας αντιστοιχίζεται αυτόματα με τα ενεργά χρηματοδοτικά προγράμματα βάσει ΚΑΔ, περιφέρειας και ημερομηνίας ίδρυσης. Τα ταιριάσματα ενημερώνονται σε πραγματικό χρόνο.
  `)}
  ...
  ${emailSection('📊', 'Λεπτομερής ανάλυση κριτηρίων επιλεξιμότητας', `
    Για κάθε ταίριασμα βλέπετε αναλυτικά γιατί μια επιχείρηση ταιριάζει — ή δεν ταιριάζει — με κάθε πρόγραμμα. ΚΑΔ, περιφέρεια, νομική μορφή, ηλικία επιχείρησης, ειδικά κριτήρια.
  `)}
