...
export const bulkAssignExpenseUnit = (data) => api.post('/expenses/bulk-assign-unit', data)
...
export const createPropertyInBeds24 = (unitId) => api.post(`/beds24/units/${unitId}/create-property`)
