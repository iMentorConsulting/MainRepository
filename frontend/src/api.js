...
export const getPortalRelatedCases = (token) =>
  axios.get(`${BASE}/api/cm/portal/public/${token}/related-cases`).then(r => r.data)
...
export const downgradeWorkedLeads = () => api.post('/api/cm/leads/downgrade-worked').then(r => r.data)
