...
Η iMentor Consulting έχει ενεργοποιήσει για εσάς την Πύλη Πελάτη, όπου μπορείτε να παρακολουθείτε σε πραγματικό χρόνο την πορεία της υπόθεσής σας.

🔗 {portal_url}

Για είσοδο χρειάζεστε το ΑΦΜ της επιχείρησής σας.
