...
def accept_assignment(
    ...
    # Fallback 2: programTitle field from the webhook itself (may be the full program name)
    if not prog_title and (a.program_title or "").strip() and len((a.program_title or "").strip()) > 10:
