...
_ANAKAINIZW_DESCS = {
    "ΥΠΟΒΟΛΗ ΦΟΡΜΑΣ ΕΝΔΙΑΦΕΡΟΝΤΟΣ": (
        "Η αίτηση ενδιαφέροντός σας έχει ληφθεί! Για να ξεκινήσει η διαδικασία, "
        "παρακαλούμε συνδεθείτε στην Πύλη Πελάτη και συμπληρώστε τα απαιτούμενα στοιχεία. "
        "Ο σύμβουλός σας θα σας καθοδηγήσει για τα επόμενα βήματα."
    ),
    "ΣΥΜΠΛΗΡΩΣΗ ΣΤΟΙΧΕΙΩΝ ΝΟΙΚΟΚΥΡΙΟΥ & ΕΙΔΙΚΩΝ ΣΥΝΘΗΚΩΝ": (
        "Παρακαλούμε συνδεθείτε στην Πύλη Πελάτη και συμπληρώστε τη φόρμα με τα στοιχεία "
        "του νοικοκυριού σας (εισόδημα, σύνθεση) και τυχόν ειδικές συνθήκες (ΑμΕΑ, τρίτεκνοι κ.λπ.). "
        "Τα στοιχεία αυτά είναι απαραίτητα για τον προκαταρκτικό έλεγχο επιλεξιμότητάς σας."
    ),
    "ΑΠΟΣΤΟΛΗ ΕΓΓΡΑΦΩΝ ΑΚΙΝΗΤΟΥ": (
        "Αναμένουμε τα απαραίτητα έγγραφα του ακινήτου σας (τίτλοι ιδιοκτησίας, Ε9, ΕΝΦΙΑ κ.λπ.). "
        "Μπορείτε να τα αποστείλετε εύκολα μέσω της Πύλης Πελάτη."
    ),
    "ΠΛΗΡΩΜΗ 49€+ΦΠΑ": (
        "Για να προχωρήσει ο έλεγχος εγγράφων και επιλεξιμότητας από τον σύμβουλό σας, "
        "απαιτείται η καταβολή παραβόλου 49€+ΦΠΑ. "
        "Ο σύμβουλός σας σάς έχει αποστείλει οδηγίες πληρωμής με IBAN. "
        "Μόλις ολοκληρωθεί η πληρωμή, ενημερώστε μας και η διαδικασία συνεχίζεται άμεσα."
    ),
    "ΕΛΕΓΧΟΣ ΕΠΙΛΕΞΙΜΟΤΗΤΑΣ ΑΠΟ ΣΥΜΒΟΥΛΟ": (
        "Ο σύμβουλός σας ελέγχει τα στοιχεία και τα έγγραφά σας για να επιβεβαιώσει "
        "ότι πληρούτε τα κριτήρια επιλεξιμότητας του προγράμματος Ανακαινίζω. "
        "Δεν απαιτείται καμία ενέργεια από εσάς αυτή τη στιγμή."
    ),
    "ΟΛΟΚΛΗΡΩΣΗ ΕΛΕΓΧΟΥ ΑΠΟ ΣΥΜΒΟΥΛΟ": (
        "Ο προκαταρκτικός έλεγχος επιλεξιμότητας ολοκληρώθηκε. "
        "Σύντομα θα ενημερωθείτε από τον σύμβουλό σας για το αποτέλεσμα και τα επόμενα βήματα της αίτησής σας."
    ),
