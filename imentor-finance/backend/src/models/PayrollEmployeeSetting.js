...
const PayrollEmployeeSetting = sequelize.define('PayrollEmployeeSetting', {
  ...
  target_type:   { type: DataTypes.STRING(50), defaultValue: 'multiplier' },
  ...
  is_ika_supplier:      { type: DataTypes.BOOLEAN, defaultValue: false },          // marks this supplier as the IKA institution expense account
}, {
