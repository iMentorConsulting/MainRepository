...
function buildViberMessage(type, name, url) {
  switch (type) {
    case 'initial':
      return `Αγαπητέ/ή ${name},\n\nΗ ανάλυση των στοιχείων σας από τον Εξωδικαστικό Μηχανισμό ολοκληρώθηκε. Έχουμε ετοιμάσει τις εκτιμήσεις μας για τη ρύθμιση των οφειλών σας.\n\nΜπείτε με το ΑΦΜ σας και δείτε την πλήρη ανάλυση:\n${url}\n\nΕίμαστε στη διάθεσή σας για οποιαδήποτε ερώτηση. 🤝\n\ni-Mentor Consulting`
    case 'reminder1':
      return `Αγαπητέ/ή ${name},\n\nΘέλαμε να σας υπενθυμίσουμε ότι η ανάλυση ρύθμισης οφειλών σας είναι έτοιμη και σας περιμένει.\n\nΔείτε τα αποτελέσματα με το ΑΦΜ σας:\n${url}\n\nΕίμαστε στη διάθεσή σας για απορίες. 😊\n\ni-Mentor Consulting`
    case 'reminder2':
      return `Αγαπητέ/ή ${name},\n\n2η υπενθύμιση για την ανάλυση ρύθμισης οφειλών σας. Η διαδικασία έχει συγκεκριμένα χρονικά πλαίσια και δεν θέλουμε να χάσετε αυτή την ευκαιρία.\n\nΠαρακαλούμε δείτε την ανάλυσή σας άμεσα:\n${url}\n\nΕπικοινωνήστε μαζί μας για να συζητήσουμε τις επιλογές σας.\n\ni-Mentor Consulting`
    case 'final':
      return `Αγαπητέ/ή ${name},\n\n⚠️ Τελευταία υπενθύμιση — η προθεσμία για τον Εξωδικαστικό Μηχανισμό πλησιάζει.\n\nΗ ανάλυσή σας είναι έτοιμη. Μην χάσετε αυτή την ευκαιρία ρύθμισης των οφειλών σας.\n\n👉 ${url}\n\nΕπικοινωνήστε μαζί μας ΣΗΜΕΡΑ.\n\ni-Mentor Consulting`
    default:
      return ''
  }
}
