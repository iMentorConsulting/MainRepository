...
export function buildForecastText(calc, incomeData) {
  ...
  const noteSection = {
    ...
    body: 'Η παρούσα εκτίμηση αποτελεί θεωρητική προσομοίωση και δεν συνιστά νομική ή οικονομική δέσμευση. Η i-Mentor Consulting δεν δύναται να εγγυηθεί το τελικό αποτέλεσμα, το οποίο εξαρτάται από πολλαπλούς παράγοντες (αποδοχή πιστωτών, αξιολόγηση περιουσίας κ.ά.).',
  }
